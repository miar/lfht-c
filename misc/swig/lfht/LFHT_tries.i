...
#define LFHT_InsertOnDeletePool(NODE)                                            \
 ...
 void LFHT_SHOW_DELETE_POOL(char *user_out) { 
  FILE *out; 					       
  LFHT_Bool file;
...
/*
 LFHT_STR_PTR LFHT_CHECK_INSERT_KEY_ORIGINAL(LFHT_NODE_KEY_STR key LFHT_USES_ARGS) {
  LFTH_ShiftDeleteBits(key);
...
/*
 LFHT_STR_PTR LFHT_CHECK_INSERT_FIRST_CHAIN_ORIGINAL(LFHT_STR_PTR chain_node, LFHT_NODE_KEY_STR key, int count_nodes LFHT_USES_ARGS) {
  if (LFHT_IsEqualKey(chain_node, key))
    return chain_node;  
  int cn = count_nodes + 1;
  LFHT_STR_PTR chain_next;
...
/*
 LFHT_STR_PTR LFHT_CHECK_INSERT_BUCKET_ARRAY(LFHT_STR_PTR *curr_hash,  LFHT_NODE_KEY_STR key, int n_shifts LFHT_USES_ARGS) {
  LFHT_STR_PTR *bucket;
  LFHT_GetBucket(bucket, curr_hash, key, n_shifts, LFHT_STR);
  //  if (key == 5)
...
/*
 LFHT_STR_PTR LFHT_CHECK_INSERT_BUCKET_CHAIN(LFHT_STR_PTR *curr_hash, 
							  LFHT_STR_PTR chain_node,  
							  LFHT_NODE_KEY_STR key, 
							  int n_shifts, 
							  int count_nodes  
...
/*
 void LFHT_ADJUST_CHAIN_NODES(LFHT_STR_PTR *new_hash, 
					   LFHT_STR_PTR chain_node, 
...
*/
 ...
 void LFHT_INSERT_BUCKET_ARRAY(LFHT_STR_PTR *curr_hash, 
					    LFHT_STR_PTR chain_node, 
					    int n_shifts 
					    LFHT_USES_REGS) {
...
*/
 ...
 void LFHT_INSERT_BUCKET_CHAIN(LFHT_STR_PTR *curr_hash, 
					    LFHT_STR_PTR chain_node, 
...
/* ------------------------------------------------------------------------------------*/
 ...
 void LFHT_SHOW_STATE(char *user_out) {
  FILE *out; 					       
  LFHT_Bool file;
  LFHT_STR_PTR first_node;
 ...
 void LFHT_SHOW_CHAIN(LFHT_STR_PTR chain_node,
 ...
 void LFHT_SHOW_BUCKET_ARRAY(LFHT_STR_PTR *curr_hash,
					  FILE *out) {
  int i;
  LFHT_STR_PTR *bucket;
...
/* ------------------------------------------------------------------------------------*/
 ...
 void LFHT_SHOW_STATISTICS(char *user_out) {
  FILE *out; 					       
  LFHT_Bool file;
  LFHT_STR_PTR first_node;
 ...
 void LFHT_SHOW_STATISTICS_CHAIN(LFHT_STR_PTR chain_node,
					      LFHT_STR_PTR *end_chain) {
 ...
 void LFHT_SHOW_STATISTICS_BUCKET_ARRAY(LFHT_STR_PTR *curr_hash) {
  int i;
  LFHT_STR_PTR *bucket;
  LFHT_StatisticsUsedBucketArrayEntries++;
  bucket = (LFHT_STR_PTR *) LFHT_UntagHashLevel(curr_hash);
...
/* -------------------------------------------------------------------*/
 ...
 void LFHT_ABOLISH_ALL_KEYS(void) {
  LFHT_STR_PTR first_node;
  LFHT_GetFirstNode(first_node);
 ...
 void LFHT_ABOLISH_CHAIN(LFHT_STR_PTR chain_node,
				      LFHT_STR_PTR * end_chain) {
 ...
 void LFHT_ABOLISH_BUCKET_ARRAY(LFHT_STR_PTR *curr_hash) {
  int i;
  LFHT_STR_PTR *bucket;
  bucket = (LFHT_STR_PTR *) LFHT_UntagHashLevel(curr_hash);
  for (i = 0; i < LFHT_BUCKET_ARRAY_SIZE ; i++) {
...
/* ------------------------------------------------------------------------------------*/
 ...
 void LFHT_CREATE_INIT_ENV(void) {
...
/* ------------------------------------------------------------------------------------*/
 ...
 LFHT_ThreadEnvPtr LFHT_CREATE_INIT_THREAD_ENV(int tid) {
 ...
 void LFHT_KILL_THREAD_ENV(int tid) {
  LFHT_ThreadEnvPtr tenv = &(LFHT_ThreadEnv(LFHT_ROOT_ENV, tid));
